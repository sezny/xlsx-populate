...
class Workbook {
    ...
    outputAsync(opts) {
        ...
        let definedNamesNode = xmlq.findChild(this._node, "definedNames") || xmlq.findChild(this._node, "x:definedNames");
    ...
    _initAsync(data, opts) {
        ...
        return externals.Promise.resolve()
            ...
            .then(nodes => {
                ...
                // Load each sheet.
                this._sheetsNode = xmlq.findChild(this._node, "sheets") || xmlq.findChild(this._node, "x:sheets");
    ...
    _parseSheetRefs() {
        ...
        const bookViewsNode = xmlq.findChild(this._node, "bookViews") || xmlq.findChild(this._node, "x:bookViews");
        const workbookViewNode = bookViewsNode && (xmlq.findChild(bookViewsNode, "workbookView") || xmlq.findChild(bookViewsNode, "x:workbookView"));
        ...
        const definedNamesNode = xmlq.findChild(this._node, "definedNames") || xmlq.findChild(this._node, "x:definedNames");
        if (definedNamesNode) {
    ...
    _setSheetRefs() {
        ...
        let bookViewsNode = xmlq.findChild(this._node, "bookViews") || xmlq.findChild(this._node, "x:bookViews");
        if (!bookViewsNode) {
            bookViewsNode = { name: 'bookViews', attributes: {}, children: [] };
            xmlq.insertInOrder(this._node, bookViewsNode, nodeOrder);
        }

        let workbookViewNode = xmlq.findChild(bookViewsNode, "workbookView") || xmlq.findChild(bookViewsNode, "x:workbookView");
        if (!workbookViewNode) {
