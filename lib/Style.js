...
class Style {
    ...
    _get_underline() {
        const uNode = xmlq.findChild(this._fontNode, 'u') || xmlq.findChild(this._fontNode, 'x:u');
    ...
    _get_fill() {
        const patternFillNode = xmlq.findChild(this._fillNode, 'patternFill') || xmlq.findChild(this._fillNode, 'x:patternFill');// jq.get(this._fillNode, "patternFill[0]");
        const gradientFillNode = xmlq.findChild(this._fillNode, 'gradientFill') || xmlq.findChild(this._fillNode, 'x:gradientFill');// jq.get(this._fillNode, "gradientFill[0]");
