...
class StyleSheet {
    ...
    _init(node) {
        ...
        this._numFmtsNode = xmlq.findChild(this._node, "numFmts") || xmlq.findChild(this._node, "x:numFmts");
        this._fontsNode = xmlq.findChild(this._node, "fonts") || xmlq.findChild(this._node, "x:fonts");
        this._fillsNode = xmlq.findChild(this._node, "fills") || xmlq.findChild(this._node, "x:fills");
        this._bordersNode = xmlq.findChild(this._node, "borders") || xmlq.findChild(this._node, "x:borders");
        this._cellXfsNode = xmlq.findChild(this._node, "cellXfs") || xmlq.findChild(this._node, "x:cellXfs");
