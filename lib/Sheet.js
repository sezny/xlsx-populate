...
class Sheet {
    ...
    activeCell() {
        ...
        let selectionNode = xmlq.findChild(sheetViewNode, "selection") || xmlq.findChild(sheetViewNode, "x:selection");
    ...
    tabColor() {
        return new ArgHandler("Sheet.tabColor")
            .case(() => {
                const tabColorNode = xmlq.findChild(this._sheetPrNode, "tabColor") || xmlq.findChild(this._sheetPrNode, "x:tabColor");
    ...
    panes() {
        ...
        const sheetViewNode = this._getOrCreateSheetViewNode();
        let paneNode = xmlq.findChild(sheetViewNode, 'pane') || xmlq.findChild(sheetViewNode, 'x:pane');
    ...
    _getOrCreateSheetViewNode() {
        let sheetViewsNode = xmlq.findChild(this._node, "sheetViews") || xmlq.findChild(this._node, "x:sheetViews");
        if (!sheetViewsNode) {
            sheetViewsNode = {
                name: "sheetViews",
                attributes: {},
        ...
        return xmlq.findChild(sheetViewsNode, "sheetView") || xmlq.findChild(sheetViewsNode, "x:sheetView");
    }
    ...
    _init(workbook, idNode, node, relationshipsNode) {
        ...
        // Create the rows.
        this._rows = [];
        this._sheetDataNode = xmlq.findChild(this._node, "sheetData") || xmlq.findChild(this._node, "x:sheetData");
        ...
        this._columns = [];
        this._colsNode = xmlq.findChild(this._node, "cols") || xmlq.findChild(this._node, "x:cols");
        if (this._colsNode) {
        ...
        this._sheetPrNode = xmlq.findChild(this._node, "sheetPr") || xmlq.findChild(this._node, "x:sheetPr");
        ...
        this._mergeCellsNode = xmlq.findChild(this._node, "mergeCells") || xmlq.findChild(this._node, "x:mergeCells");
        ...
        this._dataValidationsNode = xmlq.findChild(this._node, "dataValidations") || xmlq.findChild(this._node, "x:dataValidations");
        ...
        this._hyperlinksNode = xmlq.findChild(this._node, "hyperlinks") || xmlq.findChild(this._node, "x:hyperlinks");
        ...
        this._printOptionsNode = xmlq.findChild(this._node, "printOptions") || xmlq.findChild(this._node, "x:printOptions");
        if (this._printOptionsNode) {
        ...
        this._pageMarginsNode = xmlq.findChild(this._node, "pageMargins") || xmlq.findChild(this._node, "x:pageMargins");
        ...
        ['colBreaks', 'rowBreaks'].forEach(name => {
            this[`_${name}Node`] = xmlq.findChild(this._node, name) || xmlq.findChild(this._node, `x:${name}`);
            if (this[`_${name}Node`]) {
